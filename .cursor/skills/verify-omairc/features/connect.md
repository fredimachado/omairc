...
- `connect-scrollbar` shows a vertical scrollbar on the form when Password is off-screen, and on the network list once it overflows. The bars stay visible without hover. The form bar does not cover the fields. The card width stays the same.
