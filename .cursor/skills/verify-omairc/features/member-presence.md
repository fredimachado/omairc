...
- Our own row is the only one that shows away chrome without `away-notify`. It tracks the `305` / `306` numerics and the identity footer, not member presence.
