...
Keyboard is the window chord map: walk conversations, walk network headers, jump unread, complete nicks, recall sent lines, find in the buffer, focus members, close a direct message, and show this list. Clicks still work. Status is not a sidebar row.
