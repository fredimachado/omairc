...
struct IrcCommand
{
    enum class Verb { Empty, Say, Action, Join, Part, Nick, Quit, Clear, Close, Query, Msg, Topic, Notice, Away, Back, Whois, Mode, Kick, Invite, Ignore, Unignore, Ignored, Mute, Unmute, Muted, Op, Deop, Voice, Devoice, Ban, Ns, Cs, Raw, Help, Unknown };
