...
- Opening the Windows window from Explorer or the Start Menu no longer flashes a console. `--help` and the local CLI still print by attaching to the parent terminal.
